  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="pointer-events-none absolute -top-[200px] left-1/2 -translate-x-1/2 h-[400px] w-[800px] opacity-[0.06] blur-3xl"
          style={{
            background:
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <h1 className="mt-6 font-[family-name:var(--font-playfair)] text-5xl leading-tight font-bold tracking-tight text-[#f5f5f5]">
            ...
            <br />
            iAgent is the sovereign evolution.
          </h1>
          ...
          <p className="mt-8 text-sm tracking-wide text-[#f5f5f5]/70">
            Evolved from OpenClaw · Hardened security · Zero API cost · Anthropic only
          </p>
        </div>
      </section>
      ...
      <section id="get-runbook" className="px-6 py-20 sm:py-28">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg leading-relaxed text-[#f5f5f5]/85">
            ...
            email.
            <br />
            Receive the runbook. Open it with Claude Code.
          </p>
